...
import { useLenis, scrollToTarget } from "@/components/providers/smooth-scroll";
...
export function StaysClient() {
  ...
  const handleScrollToRooms = () => {
    scrollToTarget(lenis, roomsSectionRef.current, -88);
  };

  const handleScrollToCompare = () => {
    scrollToTarget(lenis, "compare", -88);
  };
  ...
  const handleSelectCategory = (cat: FilterCategory) => {
    ...
    // Scroll to specific room with fallback to native
    scrollToTarget(lenis, cat, -88);
  };
