        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden font-sans">
            ...
            <section className="py-28 sm:py-36 md:py-40 relative overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    <motion.div
                        {...fadeInUp}
                        className="max-w-4xl mx-auto bg-gradient-to-b from-white/5 to-transparent p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-3xl border border-white/10"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium mb-4">
                            Ready for an <br />
                            <span className="text-[#00c97b] italic">Unforgettable Escape?</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5">
                            <a href="/book">
                                <AnimatedCTAButton text="Plan Your Experience" className="w-full sm:w-auto h-11 px-5 text-sm font-semibold group shadow-lg shadow-emerald-950/30" />
                            </a>
                            <a
                                href="/contact"
                                className="flex items-center justify-center gap-2 h-11 px-5 bg-neutral-900/80 backdrop-blur-sm text-white rounded-xl border border-white/20 hover:bg-neutral-800 transition-all duration-300 text-sm font-semibold"
                            >
                                Contact Support
