...
export function EventsClient() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden font-sans">
            ...
            <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl px-6">
                    ...
                    <p className="text-neutral-300 text-base sm:text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-10 font-light">
                        ...
                        Vanrai Resort transforms every event into an unforgettable experience.
                    </p>

                    <div className="flex justify-center gap-3.5 sm:gap-5 flex-wrap">
                        <Link href="/contact" className="h-11 px-6 bg-green-500 hover:bg-green-400 text-black font-medium rounded-[14px] transition-all flex items-center justify-center text-sm shadow-lg shadow-green-500/25">
                            Plan Your Event
                        </Link>
            ...
            <section id="event-categories" className="scroll-mt-24 sm:scroll-mt-28 py-24 sm:py-32 relative">
                <div className="max-w-7xl mx-auto px-6 space-y-24 sm:space-y-36">

                    {/* Weddings - Image Right */}
                    <div className="grid md:grid-cols-2 items-center gap-10 lg:gap-14">
                        <motion.div {...fadeInUp} className="space-y-6 order-2 md:order-1">
                            <div className="flex items-center gap-2.5 text-green-400">
                                ...
                                <span className="tracking-widest uppercase text-xs sm:text-sm font-medium">Destination Weddings</span>
                            </div>
                            <h3 className="text-2xl sm:text-3xl md:text-4xl font-light leading-snug">
                                Begin Your Forever in <br />
                                <span className="italic text-neutral-400">Pure Serenity</span>
                            </h3>
                            <p className="text-neutral-400 text-sm sm:text-base leading-relaxed">
                                Our lush green lawns, poolside settings, and modern banquet areas provide
                                the perfect backdrop for your special day. From intimate haldi ceremonies
                                to grand receptions under starlit skies, we manage every detail with warmth and perfection.
                            </p>
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-2">
                                <div className="p-3.5 sm:p-4 rounded-xl bg-white/[0.02] border border-white/10">
                                    <p className="text-xs sm:text-sm font-medium text-white">Grand Mandap</p>
                                    <p className="text-[11px] sm:text-xs text-neutral-400 mt-0.5">Custom setup on expansive lawns</p>
                                </div>
                                <div className="p-3.5 sm:p-4 rounded-xl bg-white/[0.02] border border-white/10">
                                    <p className="text-xs sm:text-sm font-medium text-white">Poolside Haldi</p>
                                    <p className="text-[11px] sm:text-xs text-neutral-400 mt-0.5">Vibrant floral decor by the pool</p>
                                </div>
                            </div>
                        ...
                        <motion.div {...imageReveal} className="relative h-[300px] sm:h-[400px] md:h-[480px] rounded-[22px] sm:rounded-[26px] overflow-hidden order-1 md:order-2 border border-white/10">
                            <Image
                                ...
                                alt="Vanrai Resort Destination Wedding Hall & Stage"
                            />
                        </motion.div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-10 lg:gap-14">
                        <motion.div {...imageReveal} className="relative h-[300px] sm:h-[400px] md:h-[480px] rounded-[22px] sm:rounded-[26px] overflow-hidden border border-white/10">
                            <Image
                                ...
                                fill
                                className="object-cover transition-transform duration-700 hover:scale-105"
                                alt="Festive Events at Vanrai Resort"
                            />
                        </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-2 items-center gap-10 lg:gap-14 mb-16 sm:mb-20">
                        <motion.div {...fadeInUp} className="space-y-6">
                            ...
                            <p className="text-neutral-400 text-sm sm:text-base leading-relaxed">
                                Escape the boardroom and host your next corporate retreat or team-building event at Vanrai Resort.
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-10 lg:gap-14">
                        ...
                        <motion.div {...fadeInUp} className="space-y-6 order-1 md:order-2">
                            ...
                            <p className="text-neutral-400 text-sm sm:text-base leading-relaxed">
                                ...
                                Vanrai Resort is the perfect stage for life's most beautiful moments.
                            </p>
                            ...
                            {[
                                {
                                    ...
                                    quote: "We chose Vanrai Resort for our destination wedding, and it was the best decision we made. The natural surroundings added a magical touch."
                                },
                                {
                                    name: "Corporate Team",
