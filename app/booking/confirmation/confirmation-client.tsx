...
export function ConfirmationClient() {
  ...
  useEffect(() => {
    ...
    const id = "VR-" + Math.random().toString(36).substring(2, 8).toUpperCase();
    setBookingId(id);
      ...
      <main className="container mx-auto px-4 pt-32 pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
             ...
             >
               Thank You For Choosing Vanrai Resort. We&apos;re Excited To Host You!
             </motion.p>
          </div>
                ...
                <div className="space-y-5">
                   ...
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         ...
                         <span className="text-xs sm:text-sm font-medium">Vanrai Resort, Near Ahmednagar</span>
                      </div>
                   </div>
                </div>
