            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    {issubmitted ? (
                        ...
                        >
                            ...
                            <div className="relative mb-20 max-w-4xl mx-auto px-4">
                                {/* Background track - centered on circles */}
                                ...
                                <div className="flex justify-between items-start">
                                    {steps.map((step) => (
                                        <div key={step.id} className="flex flex-col items-center group w-24 sm:w-32 relative z-10 text-center">
                                            {/* Circle Container */}
                                            <div className="relative mb-6">
                                                <motion.div
                                                    ...
                                                    animate={{
                                                        ...
                                                        backgroundColor: currentStep > step.id ? "#10B981" : currentStep === step.id ? "#0F172A" : "#0F172A",
                                                        borderColor: currentStep >= step.id ? "#10B981" : "rgba(255,255,255,0.08)",
                                                    }}
                                                    transition={{ duration: 0.4, ease: "easeOut" }}
                                                    className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-xl sm:text-2xl font-black border-2 relative transition-all duration-500
                                                ${currentStep === step.id ? "shadow-[0_0_40px_rgba(16,185,129,0.3)] ring-1 ring-green-500/50" : ""}
                                                ${currentStep > step.id ? "shadow-[0_0_20px_rgba(16,185,129,0.15)]" : ""}
                                            `}
                                                >
                                                    {/* Advanced Glow for active step */}
                                                    {currentStep === step.id && (
                                                        <motion.div
                                                            layoutId="stepGlow"
                                                            className="absolute -inset-1 rounded-full bg-green-500/10 blur-xl -z-10"
                                                        />
                                                    )}
                                                    ...
                                                    {currentStep > step.id ? (
                                                        ...
                                                        >
                                                            <Check className="w-7 h-7 sm:w-9 sm:h-9 stroke-[3px]" />
                                                        </motion.div>
                                                    ) : (
                                                        <span className={`${currentStep === step.id ? "text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]" : "text-gray-600 group-hover:text-gray-500"} transition-colors relative z-10`}>
                                                            {step.id}
                                                        </span>
                                                    )}
                                                    ...
                                                    {currentStep === step.id && (
                                                        <div className="absolute -inset-2 rounded-full border border-green-500/20 animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite]" />
                                                    )}
                                                </motion.div>
                                            </div>
                                            ...
                                            >
                                                <span className={`text-[9px] sm:text-[10px] font-black tracking-[0.3em] uppercase transition-all duration-300
                                            ${currentStep === step.id ? "text-green-500" : "text-gray-600"}
                                        `}>
                                                    Step 0{step.id}
                                                </span>
                                                <span className={`text-[11px] sm:text-[14px] font-extrabold tracking-tight uppercase leading-[1.2] block px-2 transition-all duration-300
                            ...
                            {/* Form Content */}
                            <div className="bg-[#131d33]/50 backdrop-blur-xl rounded-[2rem] border border-white/10 p-6 sm:p-10 md:p-12 shadow-2xl relative overflow-hidden">
                                ...
                                {/* Navigation Buttons */}
                                <div className="flex justify-between pt-8 mt-auto border-t border-white/10">
                                    <button
                                        onClick={handleBack}
                                        disabled={currentStep === 1}
                                        className={`flex items-center gap-2 px-6 py-3.5 rounded-full font-semibold transition-all group ${currentStep === 1
                                    ...
                                    {currentStep < 4 ? (
                                        <button
                                            onClick={handleNext}
                                            className="flex items-center gap-3 px-8 py-3.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white rounded-full font-bold shadow-lg shadow-green-500/25 transition-all hover:scale-[1.02] hover:shadow-green-500/40"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-3 px-10 py-3.5 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 text-white rounded-full font-bold shadow-xl shadow-green-500/30 transition-all hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed w-full sm:w-auto justify-center"
                                        >
                                            {isSubmitting ? (
                                                <>
                                                ...
                                                <>
                                                    Confirm & Submit <Check className="w-5 h-5" />
                                                </>
                                            )}
                                        </button>
                                    )}
                ...
                {!issubmitted && (
                    <motion.div
                        ...
                        className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-24 mb-10"
                    >
                        {/* Contact Info Card */}
                        <div className="bg-[#131d33]/50 backdrop-blur-xl rounded-[2.5rem] border border-white/10 p-8 sm:p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden group">
                            {/* Decorative Glow */}
                            <div className="absolute -top-24 -left-24 w-48 h-48 bg-green-500/10 rounded-full blur-[80px] group-hover:bg-green-500/20 transition-colors duration-700" />

                            <div className="relative z-10 space-y-10">
                                <div className="border-l-4 border-green-500 pl-6">
                                    <h3 className="text-3xl font-medium text-white tracking-tight">Visit Our Resort</h3>
                                    <p className="text-gray-400 mt-2 text-lg">Experience the tranquility of nature firsthand.</p>
                                </div>

                                <div className="space-y-8">
                                    <div className="flex items-start gap-5">
                                        <div className="p-4 bg-green-500/10 rounded-2xl text-green-400 mt-1 shadow-inner border border-green-500/10">
                                            <MapPin className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h4 className="text-white font-bold text-xl mb-1">Location</h4>
                                            <p className="text-gray-400 leading-relaxed text-lg">
                                                G.No 648, Wadgaon Gupta, Ahmednagar-Shendi City By-Pass, Ahmednagar, Maharashtra 414111
                                            </p>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-5">
                                        <div className="p-4 bg-emerald-500/10 rounded-2xl text-emerald-400 mt-1 shadow-inner border border-emerald-500/10">
                                            <Phone className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h4 className="text-white font-bold text-xl mb-1">Direct Contact</h4>
                                            <div className="space-y-1">
                                                <p className="text-gray-400 text-lg">+91 91585 01010</p>
                                                <p className="text-gray-400 text-lg">+91 98817 31010</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="flex items-start gap-5">
                                        <div className="p-4 bg-cyan-500/10 rounded-2xl text-cyan-400 mt-1 shadow-inner border border-cyan-500/10">
                                            <Mail className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h4 className="text-white font-bold text-xl mb-1">Email Inquiry</h4>
                                            <p className="text-gray-400 text-lg">vanrai_resort@yahoo.co.in</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div className="mt-12 p-6 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl border border-green-500/20 relative z-10">
                                <p className="text-green-400 font-medium flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                                    Open 24/7 for Bookings & Inquiries
                                </p>
                            </div>
                        </div>

                        {/* Map Card */}
                        <div className="bg-[#131d33]/50 backdrop-blur-xl rounded-[2.5rem] border border-white/10 p-3 h-[500px] lg:h-auto min-h-[500px] shadow-2xl relative overflow-hidden group">
                            <div className="absolute inset-0 bg-green-500/5 group-hover:bg-transparent transition-colors duration-500 pointer-events-none z-10" />
                            <iframe
                                ...
                                className="w-full h-full relative z-0 grayscale-[20%] group-hover:grayscale-0 transition-all duration-700"
                            />
                            {/* Map Border Glow */}
